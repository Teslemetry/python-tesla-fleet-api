...
VehicleState = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "GuestMode": _reflection.GeneratedProtocolMessageType(
            "GuestMode",
            (_message.Message,),
            {
                "DESCRIPTOR": _VEHICLESTATE_GUESTMODE,
                "__module__": "vehicle_pb2",
                # @@protoc_insertion_point(class_scope:CarServer.VehicleState.GuestMode)
            },
        ),
        "DESCRIPTOR": _VEHICLESTATE,
        "__module__": "vehicle_pb2",
        # @@protoc_insertion_point(class_scope:CarServer.VehicleState)
    },
)
_sym_db.RegisterMessage(VehicleState)
_sym_db.RegisterMessage(VehicleState.GuestMode)

ClimateState = _reflection.GeneratedProtocolMessageType(
    "ClimateState",
    (_message.Message,),
    {
        "DESCRIPTOR": _CLIMATESTATE,
        "__module__": "vehicle_pb2",
        # @@protoc_insertion_point(class_scope:CarServer.ClimateState)
    },
)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b"\n%com.tesla.generated.carserver.vehicleB\007VehicleZFgithub.com/teslamotors/vehicle-command/pkg/protocol/protobuf/carserver"
