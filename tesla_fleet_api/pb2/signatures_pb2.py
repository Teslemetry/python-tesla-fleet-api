...
_AES_GCM_RESPONSE_SIGNATURE_DATA = DESCRIPTOR.message_types_by_name['AES_GCM_Response_Signature_Data']
...
AES_GCM_Response_Signature_Data = _reflection.GeneratedProtocolMessageType('AES_GCM_Response_Signature_Data', (_message.Message,), {'DESCRIPTOR': _AES_GCM_RESPONSE_SIGNATURE_DATA, '__module__': 'signatures_pb2'})
_sym_db.RegisterMessage(AES_GCM_Response_Signature_Data)
