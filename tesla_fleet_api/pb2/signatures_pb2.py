...
_AES_GCM_PERSONALIZED_SIGNATURE_DATA = DESCRIPTOR.message_types_by_name[
    "AES_GCM_Personalized_Signature_Data"
]
_HMAC_SIGNATURE_DATA = DESCRIPTOR.message_types_by_name["HMAC_Signature_Data"]
_HMAC_PERSONALIZED_SIGNATURE_DATA = DESCRIPTOR.message_types_by_name[
...
KeyIdentity = _reflection.GeneratedProtocolMessageType(
    "KeyIdentity",
    (_message.Message,),
    {
        "DESCRIPTOR": _KEYIDENTITY,
        "__module__": "signatures_pb2",
        # @@protoc_insertion_point(class_scope:Signatures.KeyIdentity)
    },
)
_sym_db.RegisterMessage(KeyIdentity)

AES_GCM_Personalized_Signature_Data = _reflection.GeneratedProtocolMessageType(
    "AES_GCM_Personalized_Signature_Data",
    (_message.Message,),
    {
        "DESCRIPTOR": _AES_GCM_PERSONALIZED_SIGNATURE_DATA,
        "__module__": "signatures_pb2",
...
HMAC_Signature_Data = _reflection.GeneratedProtocolMessageType(
    "HMAC_Signature_Data",
    (_message.Message,),
    {
        "DESCRIPTOR": _HMAC_SIGNATURE_DATA,
        "__module__": "signatures_pb2",
...
HMAC_Personalized_Signature_Data = _reflection.GeneratedProtocolMessageType(
    "HMAC_Personalized_Signature_Data",
    (_message.Message,),
    {
        "DESCRIPTOR": _HMAC_PERSONALIZED_SIGNATURE_DATA,
        "__module__": "signatures_pb2",
...
SignatureData = _reflection.GeneratedProtocolMessageType(
    "SignatureData",
    (_message.Message,),
    {
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _TAG._serialized_start = 870
    _TAG._serialized_end = 1040
    _SIGNATURETYPE._serialized_start = 1043
    _SIGNATURETYPE._serialized_end = 1196
    _SESSION_INFO_STATUS._serialized_start = 1198
    _SESSION_INFO_STATUS._serialized_end = 1293
    _KEYIDENTITY._serialized_start = 32
    _KEYIDENTITY._serialized_end = 90
    _AES_GCM_PERSONALIZED_SIGNATURE_DATA._serialized_start = 92
    _AES_GCM_PERSONALIZED_SIGNATURE_DATA._serialized_end = 209
    _HMAC_SIGNATURE_DATA._serialized_start = 211
    _HMAC_SIGNATURE_DATA._serialized_end = 245
    _HMAC_PERSONALIZED_SIGNATURE_DATA._serialized_start = 247
    _HMAC_PERSONALIZED_SIGNATURE_DATA._serialized_end = 346
    _SIGNATUREDATA._serialized_start = 349
    _SIGNATUREDATA._serialized_end = 659
    _GETSESSIONINFOREQUEST._serialized_start = 661
    _GETSESSIONINFOREQUEST._serialized_end = 731
    _SESSIONINFO._serialized_start = 734
    _SESSIONINFO._serialized_end = 867
